...
def main():
	importFourTwenty101('../data_consol/strains420101.json')
	importQannabis('../data_consol/qannabis_strains_fixed.json')
	importWikileaf('../data_consol/wikileaf_strains_all.json')
	importLeafly('../data_consol/leafly-fixed.json')
